 ...
 * 分页分板块查询文章
 */
@WebServlet(name = "TopicThumbsUpPages", value = "/TopicThumbsUpPages")
public class TopicThumbsUpPages extends HttpServlet {
    @Override
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (categoryId == null || "".equals(categoryId)) {
            // 调用业务逻辑层方法
            list = ts.getTopicByThumbsUp(currentPage, pageSize);
        } else {
            list = ts.getTopicByThumbsUp(currentPage, pageSize, categoryId);
        }
